...
vim.keymap.set("n", "<C-d>", '<cmd>echo "Use ctrl + s to go down. Usually using ctrl+d for closing stuff"<CR>')
...
vim.keymap.set({ "n", "i" }, "<left>", '<cmd>echo "Use h to move dumbass!!"<CR>')
vim.keymap.set({ "n", "i" }, "<right>", '<cmd>echo "Use l to move dumbass!!"<CR>')
vim.keymap.set({ "n", "i" }, "<up>", '<cmd>echo "Use k to move dumbass!!"<CR>')
vim.keymap.set({ "n", "i" }, "<down>", '<cmd>echo "Use j to move dumbass!!"<CR>')
